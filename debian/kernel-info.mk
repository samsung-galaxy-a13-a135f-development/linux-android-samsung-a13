...
KERNEL_BOOTIMAGE_CMDLINE = androidboot.selinux=permissive
...
DEVICE_FULL_NAME = Samsung Galaxy A13
...
# Defconfig to use
KERNEL_DEFCONFIG = exynos850-a13nsxx_defconfig
...
# will be made.
# KERNEL_IMAGE_DTB = arch/arm64/boot/dts/samsung/exynos/exynos???
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/samsung/a13/*.dtbo
...
KERNEL_IMAGE_DTB_OVERLAY_CONFIGURATION = debian/a13.cfg

# Path to the DTB directory. Only define if KERNEL_IMAGE_DTB_OVERLAY_CONFIGURATION
# is defined too.
KERNEL_IMAGE_DTB_OVERLAY_DTB_DIRECTORY = arch/arm64/boot/dts/exynos
